...
namespace IdeaCenterSeleniumTests.Pages
{
    public class BasePage
    {
        ...
        public IWebElement MyProfileLink => driver.FindElement(By.XPath(".//a[text()='My Profile']"));
        public IWebElement MyIdeasLink => driver.FindElement(By.XPath("//a[text()='My Ideas']"));
        public IWebElement CreateIdeaLink => driver.FindElement(By.XPath("//a[text()='Create Idea']"));
